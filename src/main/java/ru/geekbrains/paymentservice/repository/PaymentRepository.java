...
/*Задача репозитория — предоставить объект домена веб-сервиса на основе данных запроса,
в данном случае — строки country.

в данном случае стоит заглушка-мы сами создаем новые объекты
 */
@Component
